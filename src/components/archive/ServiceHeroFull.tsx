...
export const ServiceHeroFull = () => {
    ...
    return (
        <header
            className="relative h-[66vh] min-h-[400px] flex items-center justify-center overflow-hidden bg-cover bg-center bg-no-repeat bg-scroll md:bg-fixed"
            style={{
                backgroundImage:
