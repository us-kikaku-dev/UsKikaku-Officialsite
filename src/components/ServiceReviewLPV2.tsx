...
export const ServiceReviewLPV2 = () => {
    return (
                ...
                <div className="flex flex-col-reverse md:flex-row items-center gap-12 lg:gap-20">
                    ...
                    >
                        ...
                        <a
                            ...
                            className="inline-block border border-[#D4AF37] bg-transparent text-[#D4AF37] px-16 py-5 text-base md:text-lg tracking-widest hover:bg-[#D4AF37] hover:text-white transition-all duration-300 transform hover:scale-105 shadow-sm"
                        >
                            決算資料のレビューを受ける
                        </a>
                    </motion.div>
